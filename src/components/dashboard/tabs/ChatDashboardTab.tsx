...
import { MessageSquare, Star, Pause, Archive, ChevronLeft } from "lucide-react";
...
const ChatDashboardTab = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-240px)] -mx-8 -my-12">
      {/* Header */}
...
export default ChatDashboardTab;
